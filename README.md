...
Android Engineer | Independent Product Delivery | AI-Assisted Development & Automation
...
Telegram Bot + Python + Google Drive + VasDolly + Task queue
...
**Android:** Kotlin, Jetpack Compose, Clean Architecture, Hilt, Navigation Component

**Automation:** Python, Telegram Bot API, Google Drive API

**Tools / AI:** Cursor, Claude Code, Claude API, Git
